...
function TableSelector({ setTable, setSeats }: Props) {
  return (
    <div className="md:w-[400px] md:h-[400px] w-full aspect-square border border-gray-400 grid grid-cols-3 grid-auto-rows items-center pb-10 justify-items-center">
