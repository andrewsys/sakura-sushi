...
function Page() {
    {/* Estados para os campos do formulário e controle de validação */}
  ...
  return (
    <section className="bg-[url(/sakura-tree.jpg)] bg-cover bg-center">
        {/* Overlay escuro e centralização do conteúdo */}
        <div className="w-full h-full bg-black/60 flex flex-col gap-30 items-center justify-center px-5 lg:px-0">
            ...
            <article className="pt-30 text-white text-center">   
                ...
                <span>
                  Please submit the form or give us a call at one of the numbers available
                </span>
            </article>
            {/* Formulário de contato e informações de endereço */}
            <form
              className="bg-white flex flex-col lg:flex-row mb-50 w-full lg:w-[900px]"
            ...
            >
                <div className="w-full lg:w-[600px] p-8">
                    ...
                    <input
                        ...
                        id="Name"
                        className={clsx(
                            "outline-none border block w-full p-2 mt-1 mb-6",
                            { "border-red-500": !firstTry && name === "" }
                        )}
                        required
                        value={name}
                    ...
                    <textarea
                        ...
                        className={clsx(
                            "outline-none border block w-full p-2 mt-1 mb-6",
                            { "border-red-500": !firstTry && message === "" }
                        )}
                        required
                        value={message}
                    ...
                    <button
                        type="submit"
                        className="bg-[#FF007F] text-white font-medium px-4 py-2 mt-4 hover:bg-pink-600 transition-all duration-300 hover:cursor-pointer"
                    >
                        Submit
                    </button>
                </div>
